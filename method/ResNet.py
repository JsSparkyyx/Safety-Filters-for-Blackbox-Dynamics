...
class Encoder(torch.nn.Module):
    def __init__(self,latent_dim,n_control=2,model="resnet34",res_dim=768,num_cam=6):
...
class InDCBFTrainer(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        train_loss['loss'] = train_loss['loss_latent']*self.w_latent \
                        +loss_safe*self.w_barrier+loss_unsafe*self.w_barrier+loss_grad*self.w_barrier
