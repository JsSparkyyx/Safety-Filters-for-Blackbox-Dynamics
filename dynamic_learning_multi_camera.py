...
from data.FastLoader import DeepAccidentDataset
import torch
import argparse
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--eps_safe', default=1)
    parser.add_argument('--eps_unsafe', default=1)
    parser.add_argument('--eps_ascent', default=1)
    parser.add_argument('--dt',  '-dt', default=0.1)
    parser.add_argument('--rtol',  '-rtol', default=5e-6)
    parser.add_argument('--window_size',  '-ws', default=5)
